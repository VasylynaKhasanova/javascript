...
//     propertyName.innerText = element.name;
//
//     let propertySurname = document.createElement('div');
//     propertySurname.innerText = element.surname;
//
//     let propertyAge = document.createElement('div');
//     propertyAge.innerText = element.age;
//
//     let propertyInfo = document.createElement('div');
//     propertyInfo.innerText = element.info;
//
//     let propertyPhoto = document.createElement('img');
//     propertyPhoto.src = element.photo;
//
//     divElement.append(propertyName, propertySurname, propertyAge, propertyInfo, propertyPhoto);
//     document.body.appendChild(divElement);
//
// }
// - Є масив
...
for (const element of coursesArray) {
    ...
    hourBlock.innerText = element.hourDuration;
    ...
    wrap.append(monthBlock, hourBlock);
    divElement.append(titleBlock, wrap, modulesBlock);
    document.body.appendChild(divElement);
}